...
exports.handler = async (event, context) => {
    try {
        ...
        // 1. Mốc thời gian tạo & hết hạn (24 giờ = 86400 giây)
        const now = Math.floor(Date.now() / 1000);
        const EXPIRE_IN_SECONDS = 24 * 60 * 60;
        const expiresAt = now + EXPIRE_IN_SECONDS;

        // 2. Tạo Key ngẫu nhiên (TLGB-XXXX-XXXX)
        ...
        try {
            ...
            // Xử lý an toàn: Chuyển đổi mảng cũ sang Object nếu cần
        ...
        // 4. Lọc xóa tự động các key đã quá hạn
        ...
        // 5. Thêm Key mới cùng timestamp hết hạn
        keyMap[newKey] = expiresAt;

        // 6. Ghi đè file keys.json mới lên GitHub
